...
Namespace WindowsApplication53
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.pivotGridControl1.Fields.AddRange(New DevExpress.XtraPivotGrid.PivotGridField() { Me.fiedName, Me.fieldDate, Me.fieldValue, Me.fieldValueP, Me.fieldValue2, Me.fieldDate1})
...
'			Me.pivotGridControl1.CustomChartDataSourceData += New DevExpress.XtraPivotGrid.PivotCustomChartDataSourceDataEventHandler(Me.pivotGridControl1_CustomChartDataSourceData);
			...
			Me.fieldValueP.Caption = "% of row"
			Me.fieldValueP.FieldName = "Value"
			Me.fieldValueP.Name = "fieldValueP"
			Me.fieldValueP.SummaryDisplayType = DevExpress.Data.PivotGrid.PivotSummaryDisplayType.PercentOfRow
			' 
			' fieldValue2
			' 
